...
def test_load_raw_returns_dataframe(tmp_path) -> None:  # type: ignore[no-untyped-def]
...
def test_filter_series_correct_shape(sample_df: pd.DataFrame) -> None:
...
def test_filter_series_sorted(sample_df: pd.DataFrame) -> None:
